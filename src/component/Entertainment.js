...
function Entertainment() {
  ...
  const fetchMoreListItems = async () => {
    const nextPageUrl = `https://newsdata.io/api/1/news?apikey=pub_19960053e87236e53f91359b6fefc2f25f0c6&category=entertainment&country=in&language=en&page=${nextid}`;
 ...
 console.log(totalScoreLimit);
  ...
  useEffect(() => {
    fetch(
      'https://newsdata.io/api/1/news?apikey=pub_19960053e87236e53f91359b6fefc2f25f0c6&category=entertainment&country=in&language=en'
    )
      .then((response) => response.json())
      .then((data) => {
