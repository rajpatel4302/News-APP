...
function Entertainment() {
  ...
  const fetchMoreListItems = async () => {
    const nextPageUrl = `https://newsdata.io/api/1/news?apikey=pub_2010276638dca29869e3f6c3833e7b6011d34&category=entertainment&country=in&language=en&page=${nextid}`;
 ...
 console.log(totalScoreLimit);
  ...
  useEffect(() => {
    fetch(
      'https://newsdata.io/api/1/news?apikey=pub_2010276638dca29869e3f6c3833e7b6011d34&category=entertainment&country=in&language=en'
    )
      .then((response) => response.json())
      .then((data) => {
